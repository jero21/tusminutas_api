...
class CreateNutritionistFoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nutritionist_foods', function (Blueprint $table) {
            ...
            $table->float('gramos', 7, 2)->nullable()->default(0);
            $table->float('porcion', 7, 2)->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('nutritionist_foods');
    }
}
